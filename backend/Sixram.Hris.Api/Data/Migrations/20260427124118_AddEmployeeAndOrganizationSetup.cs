...
{
    /// <inheritdoc />
    public partial class AddEmployeeAndOrganizationSetup : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CivilStatus = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    ...
                    Address = table.Column<string>(type: "nvarchar(512)", maxLength: 512, nullable: false),
                    CityProvince = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    ...
                    EmergencyContactRelationship = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
                    EmergencyContactPhone = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    DepartmentId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    ...
                    WorkSchedule = table.Column<string>(type: "nvarchar(128)", maxLength: 128, nullable: false),
                    DateHired = table.Column<DateOnly>(type: "date", nullable: true),
                    DateRegularized = table.Column<DateOnly>(type: "date", nullable: true),
                    DateSeparated = table.Column<DateOnly>(type: "date", nullable: true),
                    ...
                    TinNumber = table.Column<string>(type: "nvarchar(32)", maxLength: 32, nullable: false),
                    OtherGovernmentId = table.Column<string>(type: "nvarchar(64)", maxLength: 64, nullable: false),
